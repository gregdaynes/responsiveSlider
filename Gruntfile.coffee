module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    shell:
      dev:
        command: 'rm -rf _build; rm -rf tmp; mkdir tmp; mkdir _build; cp index.html ./_build/index.html'
...
#         flatten: true
    ...
    watch:
      ...
      html:
        ...
        tasks: 'default'
      markdown:
        files: ['**/*.md', '!__archive/**/*.*', '!node_modules/**/*.*']
        tasks: 'default'
      images:
  ...
  # Default task.
  grunt.registerTask 'default', ['shell:dev', 'css:dev', 'js:dev', 'media:dev', 'connect', 'watch']
  grunt.registerTask 'dist',    ['shell:dev', 'css:dist', 'js:dist', 'htmlmin', 'media:dist', 'connect', 'watch']
